...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{url('tapel')}}">Tahun Pelajaran</a>
            <a class="collapse-item" href="{{url('jabatan')}}">Jabatan</a>
            <a class="collapse-item" href="{{url('dadmin')}}">Data Admin</a>
            <a class="collapse-item" href="{{url('dpembina')}}">Data Pembina</a>
            <a class="collapse-item" href="{{url('dsiswa')}}">Data Siswa</a>
        </div>
    </div>
</li>
